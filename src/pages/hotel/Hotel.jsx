      ...
      <div className="hotelContainer">
        ...
        <div className="hotelWrapper">
          ...
          <span className="hotelPriceHighlight">
            Reserve uma estadia acima de US$ 114 neste estabelecimento e ganhe um táxi gratuito do aeroporto
          </span>
          ...
          <div className="hotelDetails">
            <div className="hotelDetailsTexts">
              ...
              <p className="hotelDesc">
                Localizado a 5 minutos a pé do Portão de São Floriano em Cracóvia, o Tower
                O Street Apartments oferece acomodações com ar-condicionado e
                Wifi grátis. As unidades contam com pisos de madeira e apresentam uma
                ...
                aeroporto é John Paul II International Kraków-Balice, 16,1 km
                de Tower Street Apartments, e a propriedade oferece um pago
            ...
            <div className="hotelDetailsPrice">
              ...
              <span>
                Localizada no verdadeiro coração de Cracóvia, esta propriedade tem uma
